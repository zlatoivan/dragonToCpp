...
export function initProgramHardcode(program: Program    ) {
    // Action 1
    ...
    // Questions 1, 2
    const question1 = new Question('a < 2')
    ...
    const question2 = new Question('Q2')
